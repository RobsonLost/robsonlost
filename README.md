...
Profissional de TI com **8+ anos de experiência em Suporte Técnico N2 e Infraestrutura**, atuando com ambientes corporativos, Microsoft 365, Entra ID, Intune, Active Directory, Windows, ServiceNow, SAP e redes. Atualmente curso **Análise e Desenvolvimento de Sistemas**, buscando unir minha experiência em TI com desenvolvimento de software e Inteligência Artificial.
...
### Microsoft • Cloud • Infraestrutura
...
Projeto pessoal desenvolvido em **Python** para estudar IA Generativa aplicada ao Service Desk, explorando **LLMs, APIs, RAG, AI Agents e automação**.

[![Ver projeto](https://img.shields.io/badge/Ver_projeto-181717?style=for-the-badge\&logo=github\&logoColor=white)](https://github.com/RobsonLost/assistente-ia-service-desk)

### ADS — Faculdade

Repositório acadêmico onde registro minha evolução durante a graduação em **Análise e Desenvolvimento de Sistemas**, reunindo estudos, exercícios, códigos e projetos das disciplinas.

[![Ver projeto](https://img.shields.io/badge/Ver_repositório-181717?style=for-the-badge\&logo=github\&logoColor=white)](https://github.com/RobsonLost/ads---faculdade)
...
Atualmente aprofundando conhecimentos em **Python, Java, Engenharia de Software, Inteligência Artificial, Banco de Dados, Redes e Segurança da Informação**.
